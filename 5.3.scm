...
(define gc
  (make-machine
   '(oldcr new free scan old relocate-continue the-cars the-cdrs new-cars new-cdrs temp root)
   (list (list 'vector-ref vector-ref) (list 'vector-set! vector-set!) (list '+ +)
         (list 'pointer-to-pair? pair?) (list '= =)
         (list 'broken-heart? (lambda (x) (eq? x 'broken-heart))))
